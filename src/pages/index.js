...
export default function Home() {
  return <div className={style.wrapper}>
    ...
    <header className={style.header}>
      ...
      <p style={{ marginBottom: '2em' }}><SocialAccount /></p>
      <p style={{ position: 'relative' }} className={style.intro}>You can read my resume <img src={resumeArrow} className={style.resumeArrow}/></p>
